-- Populate entities.county from the NYSED county code (the first 2 digits of the
-- BEDS code). Authoritative mapping from NYSED data; statewide/aggregate rows
-- (synthetic BEDS codes) don't match a county and stay null.
